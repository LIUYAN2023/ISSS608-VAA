...
## 1.3 Plotting a static ternary diagram
...
```
## 1.4 Plotting an interative ternary diagram
...
## 2.2 Building Correlation Matrix
...
## 2.8 Working with visual geometrics
...
## 2.10 Working with mixed layout
...
## 2.11 Combining corrgram with the significant test
...
## 2.13 Reordering a correlation matrix using hclust
