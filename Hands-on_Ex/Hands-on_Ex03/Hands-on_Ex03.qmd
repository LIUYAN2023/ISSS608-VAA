...
[readxl:](https://readxl.tidyverse.org/)The readxl package makes it easy to get data out of Excel and into R.
...
# 2. Exercise - Interactive Data Visulization
...
Notice that two steps are involved. First, an interactive version of ggplot2 geom (i.e. [geom_dotplot_interactive()](https://davidgohel.github.io/ggiraph/reference/geom_dotplot_interactive.html)) will be used to create the basic graph. Then, girafe() will be used to generate an svg object to be displayed on an html page.
...
## 2.1.3 Customizing Tooltip style
...
## 2.1.5 Hover effect with data_id aesthetic
...
## 2.1.8 Click effect with onclick
...
## 2.2 Interactive Data Visualization - plotly methods
...
## 2.2.3 Creating an interactive scatter plot: ggplotly() method
...
## 2.2.4 Coordinated Multiple Views with plotly
...
## 3.3.2 Building an animated bubble plot: plot_ly() method
