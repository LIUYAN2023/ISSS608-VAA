...
## 1.3 Building the Calendar Heatmaps
...
## 1.4 Building Multiple Calendar Heatmaps
...
# 2. Time on the Horizon: ggHoriPlot methods
...
For the purpose of this hands-on exercise, [Average Retail Prices Of Selected Consumer Items](https://tablebuilder.singstat.gov.sg/) will be used.
